...
_EF_::EyeFinder::setMinAndMax(int start, int end,
             std::vector<dlib::full_object_detection>& shapes) {
...
// *****
// getROI
cv::Rect _EF_::EyeFinder::getROI(std::tuple<long,long,long,long>& tp, cv::Mat frame) {
  #if DEBUG
...
void _EF_::EyeFinder::preCalculationPoints(std::vector<std::pair<long,long>>& facial_features_vec) {
...
void _EF_::EyeFinder::writeFacialFeaturesToShm(const std::vector<std::pair<long,long>>& facial_features_vec) {
